...
execute as @a[scores={noise=400..}] at @s run summon minecraft:warden ~ ~ ~ {Tags:["quiet_warden"], Brain: {memories: {"minecraft:dig_cooldown":{value: {}, ttl: 1200L}, "minecraft:is_emerging": {value: {}, ttl: 85L}}}}
...
execute as @a[scores={noise=400..}] at @s run scoreboard players set PlaceholderName globalchilldown 0
